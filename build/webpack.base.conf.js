...
module.exports = {
  ...
  output: {
    ...
    filename: path.join(config.common.assetsSubDirectory, '[name].js'),
    chunkFilename: path.join(config.common.assetsSubDirectory, '[id].js')
  ...
  module: {
    loaders: [
      ...
      },
      {
        ...
        query: {
          limit: 10000,
          name: config.common.assetsSubDirectory + '/[name].[hash:7].[ext]'
        }
      },
      {
        test: /vux.src.*?js$/,
