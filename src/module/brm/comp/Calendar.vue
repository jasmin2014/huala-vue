...
<template>
    <div @click.stop=""  class="calendar animated" v-bind:class="{'bounceInDown-transition':show}" v-show="show" :style="{'left':x,'top':y,'margin': z}" transition-mode="out-in"> <!--  transition="bounceInDown" -->
        ...
        <div class="calendar-button" v-show="type=='date'||type=='datetime'||type=='time'||range"> <!-- type=='date'|| -->
            <span @click="ok">确定</span>
            <!--<span @click="cancel" class="cancel">取消</span>-->
        </div>
        <div class="button-cancel" @click="cancel">
          <span class="bcancel"><img src="../assets/closeicon.png" /></span>
